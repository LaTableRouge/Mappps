...
function mppps_register_page() {
    ...
    // $svgPath = MPPPS_PATH . '/build/img/block-icon.svg';
...
add_action('admin_menu', 'mppps_register_page');

function mppps_page_callback() {
    printf(
        '<article class="mps-admin-wrap" id="mppps_root">%s</article>',
