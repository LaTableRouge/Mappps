...
* Added compatibility with posts using `mappps_marker` meta fields (including ACF/SCF) across blocks and post details the old "lat" and "lng" will still be working
* Updated code quality in scss
