<article>
    ...
    <ol>
        <li><strong><?php esc_html_e('Add a New Post:', 'maaaps'); ?></strong> <?php esc_html_e('Go to', 'maaaps'); ?> <code><?php esc_html_e('Posts', 'maaaps'); ?></code> > <code><?php esc_html_e('Add New', 'maaaps'); ?></code>.</li>
        ...
        <li><strong><?php esc_html_e('Add Custom Fields:', 'maaaps'); ?></strong>
            <ol>
                ...
                <li><?php esc_html_e('If the "Custom Fields" section is not visible, enable it by clicking on', 'maaaps'); ?> <code><?php esc_html_e('Screen Options', 'maaaps'); ?></code> <?php esc_html_e('at the top right of the screen (the three dots) and go to', 'maaaps'); ?> <code><?php esc_html_e('Preferences', 'maaaps'); ?></code> <?php esc_html_e('then check', 'maaaps'); ?> <code><?php esc_html_e('Custom Fields', 'maaaps'); ?></code>.</li>
                <li><?php esc_html_e('Click on', 'maaaps'); ?> <code><?php esc_html_e('Add Custom Field', 'maaaps'); ?></code>. <?php esc_html_e('In the', 'maaaps'); ?> <code><?php esc_html_e('Name', 'maaaps'); ?></code> <?php esc_html_e('field, enter or select', 'maaaps'); ?> <code><?php esc_html_e('lat', 'maaaps'); ?></code> <?php esc_html_e('and in the', 'maaaps'); ?> <code><?php esc_html_e('Value', 'maaaps'); ?></code> <?php esc_html_e('field, enter the latitude coordinate.', 'maaaps'); ?></li>
                <li><?php esc_html_e('Repeat the above step for the', 'maaaps'); ?> <code><?php esc_html_e('lng', 'maaaps'); ?></code> <?php esc_html_e('field.', 'maaaps'); ?></li>
            </ol>
        </li>
        <li><strong><?php esc_html_e('Publish the Post:', 'maaaps'); ?></strong> <?php esc_html_e('Once all details are filled in, click', 'maaaps'); ?> <code><?php esc_html_e('Publish', 'maaaps'); ?></code>.</li>
    </ol>
    ...
    <ol>
        ...
        <li><strong><?php esc_html_e('Add Block:', 'maaaps'); ?></strong> <?php esc_html_e('Click the', 'maaaps'); ?> <code><?php esc_html_e('+', 'maaaps'); ?></code> <?php esc_html_e('icon to add a new block and search for', 'maaaps'); ?> <code><?php esc_html_e('Maaaps', 'maaaps'); ?></code>.</li>
    ...
    <p><?php esc_html_e('Yes, you can customize the marker color and size inside the', 'maaaps'); ?> <code><?php esc_html_e('Block settings', 'maaaps'); ?></code> > <code><?php esc_html_e('Render settings', 'maaaps'); ?></code>.</p>
