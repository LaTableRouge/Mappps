...
import { isControlAllowed, useAllowedControls, useIsPostTypeHierarchical, useOrderByOptions, usePostTypes, useTaxonomies } from '../../utils'
...
export default function QueryInspectorControls(props) {
  const { attributes, isSingular, setQuery } = props
